export const simpleWorkflow = {
  //client_id: "5140d8450f1349b99b9bd5fe74a21892",
  prompt: {
    "3": {
      inputs: {
        seed: 156680208700287,
        steps: 20,
        cfg: 8,
        sampler_name: "euler",
        scheduler: "normal",
  ...
  //   extra_pnginfo: {
  //     workflow: {
  //       id: "c92e3b2f-278e-400a-8d2f-abff2b115c6c",
  //       revision: 0,
  //       last_node_id: 9,
  //       last_link_id: 9,
  //       nodes: [
  ...
  //           properties: { cnr_id: "comfy-core", ver: "0.3.29", "Node name for S&R": "CLIPTextEncode" },
  ...
  //           properties: { cnr_id: "comfy-core", ver: "0.3.29", "Node name for S&R": "EmptyLatentImage" },
  ...
  //           properties: { cnr_id: "comfy-core", ver: "0.3.29", "Node name for S&R": "KSampler" },
  ...
  //           properties: { cnr_id: "comfy-core", ver: "0.3.29", "Node name for S&R": "VAEDecode" },
  //           widgets_values: [],
  //         },
  //         {
  //           id: 9,
  ...
  //           outputs: [],
  //           properties: { cnr_id: "comfy-core", ver: "0.3.29" },
  ...
  //           ],
  //           properties: { cnr_id: "comfy-core", ver: "0.3.29", "Node name for S&R": "CheckpointLoaderSimple" },
  ...
  //       groups: [],
  //       config: {},
  //       extra: { ds: { scale: 1, offset: [0, 0] }, frontendVersion: "1.17.11" },
  //       version: 0.4,
  //     },
  //   },
  // },
