/*
  ...
  - Added the required column `kind` to the `template_field` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_template_field" ("field_id", "field_label", "height", "id", "template_id", "width", "x", "y") SELECT "field_id", "field_label", "height", "id", "template_id", "width", "x", "y" FROM "template_field";
